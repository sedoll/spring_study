...
public class CalenderController {
    ...
    @GetMapping("cal1")
    public String cal1(@RequestParam("yyyy") String yyyy, Model model) {
        DatePicker datePicker = new DatePicker();
        List<Days365> days365List = datePicker.generatorHoliday(yyyy);
        List<String> holiList = new ArrayList<>();
        for(Days365 day:days365List) {
