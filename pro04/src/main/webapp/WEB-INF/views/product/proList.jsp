            ...
            <div class="page_wrap">
                ...
                <table class="tb1" id="myTable">
                    ...
                    <c:forEach var="pro" items="${proList }">
                        <tr>
                            <td class="item1">
                                <div class="img_tit"><a href="${path}/product/getProduct?no=${pro.no}"><img src="${path }/storage/${pro.imgSrc1 }"/></a></div>
                            </td>
                            <td class="item2">
                                <p>${pro.pname}</p>
                            </td>
                ...
                <div class="btn_group">
                    <c:if test="${sid eq 'admin' }">
                        <a href="${path}/product/addProductForm" class="inbtn">상품 등록</a>
                        <a href="${path}/product/AddReceive.do" class="inbtn">상품 입고</a>
                        <a href="${path}/product/UpdateReceive.do" class="inbtn">추가 입고</a>
                    </c:if>
                </div>
            </div>
        </section>
