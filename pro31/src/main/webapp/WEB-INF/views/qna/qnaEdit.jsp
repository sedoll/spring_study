                    ...
                    <table id="table1">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="title" id="title" class="input" placeholder="제목 입력" value="${dto.title }"  ${dto.title eq "댓글" ? 'readonly' : ''}  maxlength="98" required>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <a class="button is-info" href="${path }/qna/list.do">글 목록</a>
                            </td>
                        </tr>
                        </tbody>
                    </table>
